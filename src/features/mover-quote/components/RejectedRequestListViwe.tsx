  ...
  return (
    <>
      ...
      <main className="min-h-[calc(100vh-142px)] bg-[var(--background-100)]">
        <div className="mx-auto grid w-full max-x-[1200px] grid-cols-2 gap-6 px-6 py-16 max-lg:grid-cols-1 max-lg:justify-items-center max-md:max-w-[375px] max-md:py-6">
